...
const int carRedPin = 3;      // Pino da luz vermelha do carro
const int carGreenPin = 4;    // Pino da luz verde do carro
const int pedestrianRedPin = 5;  // Pino da luz vermelha do pedestre
const int pedestrianGreenPin = 6; // Pino da luz verde do pedestre
